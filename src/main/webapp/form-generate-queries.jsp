...
<head>
    <meta charset="UTF-8">
    <title>Gerar Atendimentos</title>
    <link rel="stylesheet"
...
<div class="container mt-4">
    <h1>Criar Atendimentos</h1>
    <p>Selecione Ano e mês para gerar lista de atendementos</p>
    ...
    <form action="/gerenate-queries" method="POST">
        ...
        <button type="submit" class="btn btn-primary mt-4">Criar Atendimentos</button>
    </form>
</div>
</body>
</html>
